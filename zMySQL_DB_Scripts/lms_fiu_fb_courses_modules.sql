...
CREATE TABLE `courses_modules` (
  ...
  KEY `FK_cm_moduleId` (`module_id`),
  CONSTRAINT `FK_cm_courseId` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`),
  CONSTRAINT `FK_cm_moduleId` FOREIGN KEY (`module_id`) REFERENCES `modules` (`id`)
...
INSERT INTO `courses_modules` VALUES (1,1,1),(2,2,2),(3,2,3);
...
-- Dump completed on 2020-02-06 21:11:35
